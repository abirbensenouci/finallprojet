      ...
      .then(res => {
        if (res.data.Login) {
          ...
          if (res.data.UserType === 'client') {
            navigate(`/welcomepagec?id_client=${res.data.id_client}&nom=${res.data.nom}&prenom=${res.data.prenom}`);
          } else if (res.data.UserType === 'avocat') {
            navigate(`/welcomepagea?code_barrau=${res.data.code_barrau}&nom=${res.data.nom}&prenom=${res.data.prenom}`);
          } else if (res.data.UserType === 'admin') {
            navigate('/welcomepageaa');
          }
        } else {

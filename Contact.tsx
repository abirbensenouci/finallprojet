...
const Contact = () => {
  ...
  <><header>
          <nav className="navbar flex pt-5">
      ...
      </header><div className="contact-map-container  contact-main">
              <div className="contact-form-container">
                  ...
                  <h1 className='m-15 text-[20px]'>{isSent && <h4>Votre message a été envoyé avec succès !</h4>} {/* afficher le message si l'envoi est réussi */}</h1>
